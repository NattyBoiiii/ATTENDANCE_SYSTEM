...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const addBtn = document.getElementById('addExcuseLetterBtn');
    if (addBtn) {
        addBtn.addEventListener('click', function() {
            toggleAddExcuseForm();
        });
    }
    const cancelAdd = document.getElementById('cancelAddExcuse');
    if (cancelAdd) {
        cancelAdd.addEventListener('click', function() {
            const form = document.getElementById('addExcuseForm');
...
window.toggleAddExcuseForm = toggleAddExcuseForm;